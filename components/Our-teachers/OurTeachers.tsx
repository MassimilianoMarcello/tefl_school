...
const OurTeachers = async () => {
  ...
  return (
    <>
      ...
      <h1 className={styles.titleTeachers}>
        {" "}
        At Tuscany TEFL School, we pride ourselves on providing top-tier
        education and training in Teaching English as a Foreign Language (TEFL).
      </h1>
      <span className={styles.titleTeachers}></span>
      <div className={styles.containerTeachersText}>
        ...
        <p className={styles.textTeachersIntroduction}>
          They bring a personalized approach to their teaching, ensuring that
          every student receives the support and guidance needed to excel. With
          a focus on practical skills, cultural awareness, and innovative
          teaching methods, our teachers are dedicated to preparing you for a
          successful career in teaching English abroad or online. Whether you
          are new to teaching or looking to enhance your skills, our teachers
          are here to guide you every step of the way. Join us and learn from
